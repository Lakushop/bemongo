...
func TestUpdateGetData(t *testing.T) {
	mconn := SetConn("MONGOULBI", "petapedia")
...
func TestCreateNewUserRole(t *testing.T) {
	...
	userdata.Role = "admin"
	mconn := SetConn("MONGOSTRING", "petapedia")
...
func TestCreateNewUserToken(t *testing.T) {
	...
	userdata.Public = publicKey // Corrected the field name from Publick to Public
...
func TestDeleteUser(t *testing.T) {
	...
	mconn := SetConn("mongodb://raulgantengbanget:0nGCVlPPoCsXNhqG@ac-oilbpwk-shard-00-00.9ofhjs3.mongodb.net:27017,ac-oilbpwk-shard-00-01.9ofhjs3.mongodb.net:27017,ac-oilbpwk-shard-00-02.9ofhjs3.mongodb.net:27017/test?replicaSet=atlas-13x7kp-shard-0&ssl=true&authSource=admin", "petapedia")
	var userdata User
